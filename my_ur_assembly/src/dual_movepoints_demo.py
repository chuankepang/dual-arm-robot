...
class MoveItIkDemo:
	...
	#末端位置1   
        target_pose1.pose.position.x = 0.7
        target_pose1.pose.position.y = 0.7
        target_pose1.pose.position.z = 1.7
        #末端姿态，四元数
	...
	#末端位置3   
        target_pose3.pose.position.x = 0.7
        target_pose3.pose.position.y = 0.2
        target_pose3.pose.position.z = 1.7
        #末端姿态，四元数
	...
	#末端位置4   
        ...
        target_pose4.pose.position.y = -0.2
