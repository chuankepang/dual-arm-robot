...
class MoveItCartesianDemo:
	...
	# 第三段退直线
        ...
        wpose.position.x -= 0.155
	wpose.position.z += 0.000
	...
	#rospy.sleep(5)        
	# 放下
        dh3_open_publisher_test.gripper_open_publisher()
	#dh3_open_publisher_test()
