...
class MoveItCartesianDemo:
	def __init__(self):
		...
		tfl.waitForTransform('world', '819_marker_frame', rospy.Time(0), rospy.Duration(2.0))
		...
		target_pose.pose.position.z = trans[2]+0.20
		...
		# target_pose.pose.orientation.x = -0.6532899
		# target_pose.pose.orientation.y = 0.2705776
		# target_pose.pose.orientation.z = 0.6532899
		# target_pose.pose.orientation.w = 0.2705776
		target_pose.pose.orientation.x = -Q[0]
		target_pose.pose.orientation.y = -Q[1]
		target_pose.pose.orientation.z = -Q[2]
		target_pose.pose.orientation.w = -Q[3] 
		...
		#末端位置2，右手预备位置1   
		target_pose.pose.position.x = trans[0]-0.155
		target_pose.pose.position.y = trans[1]
		target_pose.pose.position.z = trans[2]-0.02
		...
		joint1 = -5.979350868855612
		joint2 = -2.3730112514891566
		joint3 = -2.0068578720092773
		joint4 = 5.481305110245504
		joint5 = 3.7437667846679688
		joint6 = 2.568617343902588
		...
		target_pose.pose.position.y = trans[1]
		target_pose.pose.position.z = trans[2] - 0.107
		arm.set_start_state_to_current_state()
