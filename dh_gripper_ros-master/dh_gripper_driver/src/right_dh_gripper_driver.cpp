...
int main(int argc, char** argv)
{
    ...
    _sub_grip = n.subscribe("right/gripper/ctrl", 50, update_gripper_control);
    _gripper_state_pub = n.advertise<dh_gripper_msgs::GripperState>("right/gripper/states", 50);

    if(_gripper->GetGripperAxiNumber()==2)
    {
        _sub_rot = n.subscribe("right/gripper/rot_ctrl", 50, update_rotation_control);
        _rot_state_pub = n.advertise<dh_gripper_msgs::GripperRotState>("right/gripper/rot_states", 50);
    }
    //TODO
    ros::Publisher _gripper_joint_state_pub = n.advertise<sensor_msgs::JointState>("right/gripper/joint_states", 50); 
